    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('products', 'code')->where('company_id', $companyId)->ignore($productId),
            ],
            'category_id' => [
                'nullable',
                'string',
            ...
            'pricing_type' => ['sometimes', 'required', 'string', Rule::in(['fixed', 'per_m2', 'per_meter', 'per_kg'])],
            'unit' => ['sometimes', 'required', 'string', Rule::in(['piece', 'm2', 'linear_meter', 'kg', 'pair', 'set'])],
